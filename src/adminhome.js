    ...
    <HashRouter>
        <nav className="navbar navbar-expand-md navbar-dark sticky-top bg-dark">
            ...
            <div className="collapse navbar-collapse center" id="navbarCollapse">
                ...
                <label class="text-warning"> Welcome, { localStorage.getItem("name") } ,<Link class="text-warning" onClick={logout}> Logout </Link>
                </label>
            </div>
        </nav>
...
const logout = () =>{
    localStorage.clear(); //it clear localstorage
    window.location.reload();  //it reload the page
}
